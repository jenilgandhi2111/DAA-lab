...
public:
    ...
    //printing absolute parents for dijoint sets
    void print_dsu()
    {
        for (auto x : dsu)
        {
    ...
    //method to find absolute parent
    ...
    // This function solves Djikstra's algorithm and print it's path    
    int solve_djikstras(int src, int dest)
    {
        // If both has same absolute parent then it is
        // possible to fnd the path else not.
